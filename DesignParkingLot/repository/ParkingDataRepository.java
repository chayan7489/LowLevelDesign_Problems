package ParkingLotMain.repository;

import ParkingLotMain.entity.ParkingFloor;
import ParkingLotMain.entity.ParkingFloor;
import ParkingLotMain.entity.ParkingSlot;
...
public class ParkingDataRepository {
    ...
    public List<ParkingSlot> getAllParkingSlotData(int floorId){
        // For each iteration, a lambda expression is executed.
        // This lambda expression represents the operation to perform on each ParkingSlot object.
